...
{	int bandinises=0;
	...
	printf("%c                                                                                            %c\n", 186,186);
	printf("%c      4 - LISTADO DE ATENCION POR PROFESIONAL Y FECHA.                                      %c\n", 186,186);
	printf("%c                                                                                            %c\n", 186,186);
...
void administracion()
{
	...
	printf("%c                                                                                            %c\n", 186,186);
	printf("%c      3 - ATENCIONES POR PROFESIONAL.                                                       %c\n", 186,186);
	printf("%c                                                                                            %c\n", 186,186);
	printf("%c      4 - RANKING DE PROFESIONALES POR ATENCION.                                            %c\n", 186,186);
	printf("%c                                                                                            %c\n", 186,186);
	printf("%c      5 - CERRAR APLICACION.                                                                %c\n", 186,186);
	printf("%c                                                                                            %c\n", 186,186);
	printf("%c============================================================================================%c\n", 200,188);
	...
	scanf("%d", &opc);
		...
		switch (opc)
		{
			...
			case 4:
					{
						system ("cls");
						printf("\tRANKING DE PROFEIONALES POR ATENCIONES\n");
						ranking();
						printf ("\n\n");              
						system ("pause");
						break;
